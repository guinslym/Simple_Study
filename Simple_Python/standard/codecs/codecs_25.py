...
import codecs
from codecs_22 import encoding_map,decoding_map
...
class InvertCapsIncrementalEncoder(codecs.IncrementalEncoder):
    def encode(self,input,final=False):
        data,nbypes = codecs.charmap_encode(input,
                                                                    self.errors,
                                                                    encoding_map)
        return data
...
class InvertCapsIncrementalDecoder(codecs.IncrementalDecoder):
    def decode(self,input,final=False):
        data,nbypes = codecs.charmap_decode(input,
                                                                    self.errors,
                                                                    decoding_map)
        return data
...
if __name__ == '__main__':
    ...
    # Incremenal decoder
    decode_factory = codecs.getincrementaldecoder('invertcaps')
