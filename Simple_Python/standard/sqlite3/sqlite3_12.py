...
def adapter_func(obj):
    """Convert from in-memory to storage represention"""
    print 'adapter_func(%s)\n' % obj
    return pickle.dumps(obj)

def converter_func(data):
    """"Convert from storage to in-memory represention."""
...
# Create some objects to save.Use a list of tuples so the
# sequence can be passed directly to executemany()
